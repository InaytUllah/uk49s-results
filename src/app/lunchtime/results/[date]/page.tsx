...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `UK 49s Lunchtime winning numbers for ${formattedDate}. Check the draw results and Booster ball.`,
  };
}
...
export default async function LunchtimeResultPage({ params }: Props) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <AdSlot slot="4567890123" className="mb-6" />
      ...
      <AdSlot slot="4567890124" className="my-6" />
