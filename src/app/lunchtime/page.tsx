  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="prose dark:prose-invert max-w-none">
        ...
        <p>
          The UK 49s Lunchtime draw takes place every day at 12:49 PM UK time (GMT/BST).
        ...
        <h3>Lunchtime Draw Schedule</h3>
        <ul>
          <li><strong>Time:</strong> 12:49 PM UK time (every day)</li>
          <li><strong>Numbers drawn:</strong> 6 main + 1 Booster</li>
          <li><strong>Number range:</strong> 1 to 49</li>
        </ul>
        <p>
          Check back after each Lunchtime draw for the latest results. You can also view
          the <Link href="/teatime">Teatime results</Link> which take place at 5:49 PM UK time.
        </p>
      </section>
    </div>
  );
