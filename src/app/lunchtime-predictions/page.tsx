...
export const metadata: Metadata = {
  ...
  description: 'UK lunchtime prediction for today\'s 12:49 PM draw. Get 3 statistically weighted prediction sets based on hot & cold number trends and frequency analysis.',
