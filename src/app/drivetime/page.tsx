...
export const metadata: Metadata = {
  title: PAGE_SEO.drivetime.title,
  description: PAGE_SEO.drivetime.description,
  alternates: { canonical: '/drivetime' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <nav aria-label="Breadcrumb" className="mb-4 text-sm text-gray-500 dark:text-gray-400">
        <ol className="flex items-center gap-1">
          ...
          <li className="text-gray-900 dark:text-white font-medium">Drivetime Results</li>
        </ol>
      </nav>

      <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-2">
        UK 49s Drivetime Results
      </h1>
      <p className="text-gray-600 dark:text-gray-400 mb-2">
        Today&apos;s winning numbers drawn at 4:49 PM UK time
      </p>
      ...
      <UpcomingDraw drawType="drivetime" latestDate={latest?.date || ''} />

      <Countdown drawType="drivetime" />

      {latest ? (
        <section className="mb-8">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Latest Drivetime Result</h2>
        ...
        <section className="mb-8 p-6 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-center">
          <p className="text-gray-600 dark:text-gray-400">
            Results for today&apos;s Drivetime draw will appear here shortly after 4:49 PM UK time. Check back soon or see our <Link href="/history" className="text-emerald-600 dark:text-emerald-400 hover:underline">past results archive</Link>.
          </p>
        </section>
      )}
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Past Drivetime Results</h2>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <Link href="/drivetime-predictions" className="block p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm font-medium text-center text-gray-700 dark:text-gray-300 hover:border-emerald-400 transition-all">
          ...
          <Link href="/teatime" className="block p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm font-medium text-center text-gray-700 dark:text-gray-300 hover:border-emerald-400 transition-all">
            Teatime Results
          </Link>
      ...
      <section className="mb-8">
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 sm:p-8">
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">About UK 49s Drivetime Draw</h2>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                The <strong className="text-gray-900 dark:text-white">UK 49s Drivetime draw</strong> takes place every day at <strong className="text-gray-900 dark:text-white">4:49 PM UK time</strong> (GMT/BST), giving players a third daily betting opportunity right around the evening rush hour. Six main numbers are drawn from a pool of 1 to 49, followed by a <strong className="text-gray-900 dark:text-white">Booster ball</strong>. This page is updated immediately after each Drivetime draw with the latest winning numbers.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Drivetime Draw Schedule and Format</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody>
                    <tr><td className="py-2 px-4 border border-gray-200 dark:border-gray-700 font-medium text-gray-900 dark:text-white">Time</td><td className="py-2 px-4 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400">4:49 PM UK time (daily, including weekends)</td></tr>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Drivetime in the Daily Schedule</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                The <span className="inline-flex items-center gap-1"><span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-rose-100 text-rose-800 dark:bg-rose-900/50 dark:text-rose-300">Drivetime</span></span> draw at 4:49 PM falls between the earlier <Link href="/lunchtime" className="text-emerald-600 dark:text-emerald-400 hover:underline font-medium">Lunchtime</Link> draw (12:49 PM) and the final <Link href="/teatime" className="text-emerald-600 dark:text-emerald-400 hover:underline font-medium">Teatime</Link> draw (5:49 PM). It also follows the morning <Link href="/brunchtime" className="text-emerald-600 dark:text-emerald-400 hover:underline font-medium">Brunchtime</Link> draw at 10:49 AM. All four draws are independent and use the same 1-49 pool plus Booster format.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Tips for Drivetime Players</h3>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-gray-600 dark:text-gray-400">
                  ...
                  <span>Check the <Link href="/drivetime-predictions" className="text-emerald-600 dark:text-emerald-400 hover:underline font-medium">Drivetime predictions</Link> for data-driven suggestions</span>
                </li>
                <li className="flex items-start gap-2 text-gray-600 dark:text-gray-400">
                  <svg className="w-5 h-5 text-emerald-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'The UK 49s Drivetime draw takes place every day at 4:49 PM UK time (GMT/BST).',
                },
              },
              {
                '@type': 'Question',
                name: 'How many numbers are drawn in the Drivetime draw?',
                acceptedAnswer: {
                  '@type': 'Answer',
              ...
              {
                '@type': 'Question',
                name: 'When are Drivetime results available?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Drivetime results are typically available within minutes of the 4:49 PM draw. Check this page for the latest results updated automatically.',
                },
              },
              {
                '@type': 'Question',
                name: 'How is Drivetime different from Teatime?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Drivetime takes place at 4:49 PM and Teatime at 5:49 PM — they are exactly one hour apart but are separate, independent draws with different winning numbers.',
                },
              },
            ],
          }),
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Drivetime Results', item: 'https://uk49sresults.co.uk/drivetime' },
            ],
          }),
        }}
      />
