...
const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    icon: '🛠️',
    items: [
      { href: '/check', icon: '✅', title: 'Did I Win?', description: 'Paste your numbers, check the archive' },
      { href: '/number-generator', icon: '🎲', title: 'Random Picker', description: 'Generate random UK 49s numbers' },
      { href: '/numbers', icon: '📈', title: 'Number Statistics', description: 'Frequency data for all 49 numbers' },
      { href: '/odds', icon: '🎰', title: 'Odds & Payout Calculator', description: 'See what you\'d win for any bet' },
    ],
  },
  {
    label: 'Help',
